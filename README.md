...
- Обработка исключений в Java, [иерархия исключений](first level/exсeptions/README.md);
...
- При отладке в значительной мере использует [mocks, stubs](third%20level/mocks-stubs/README.md), мало зависит от ИТ ландшафта;
