...
# Streams API
## Что это?
* Набор методов (Api), который используется для обработки коллекций;

## В чем ценность?
* Безопасное использование памяти;
* Лаконичная обработка;
* Поддержка функционального программирования;

## Особенности
* Для реализации используют функциональные [интерфейсы](../lambdas/README.md);
* Реализуются через не терминальные и терминальные операции;
...
| `peek()`     | Операции над элементом (можно логировать). Не рекомендуется к использованию.                                                                                                                                                                                                                              |
